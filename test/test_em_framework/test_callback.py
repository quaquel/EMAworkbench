...
<<<<<<< HEAD:src/ema_workbench/test/test_em_framework/test_callback.py
...
from ema_workbench.em_framework.uncertainties import (CategoricalUncertainty,
                                                      ParameterUncertainty)
from ema_workbench.util import EMAError

>>>>>>> master:test/test_em_framework/test_callback.py
