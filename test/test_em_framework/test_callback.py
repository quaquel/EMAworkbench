...
def test_init():
    ...
    callback = DefaultCallback(
        uncs, levers, outcomes, nr_experiments=1000, reporting_interval=None, reporting_frequency=4
    )
...
def test_filebasedcallback(mocker):
    ...
    nr_experiments = 3
    uncs = [RealParameter("a", 0, 1), RealParameter("c", 0, 1)]
    levers = [RealParameter("b", 0, 1)]
