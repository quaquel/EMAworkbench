...
<<<<<<< HEAD:src/ema_workbench/test/test_em_framework/test_experiment_runner.py
...
from ema_workbench.em_framework.model import ModelStructureInterface
from ema_workbench.util import EMAError, CaseError
>>>>>>> master:test/test_em_framework/test_experiment_runner.py
