...
import mock
import numpy as np
<<<<<<< HEAD:src/ema_workbench/test/test_em_framework/test_model_ensemble.py
import unittest
...
from ema_workbench.em_framework import (ModelStructureInterface, ParameterUncertainty,
                                        Outcome)
from ema_workbench.em_framework.model_ensemble import (ModelEnsemble, UNION, INTERSECTION,
                                                       experiment_generator)
from ema_workbench.em_framework.samplers import LHSSampler
from ema_workbench.util.ema_exceptions import EMAError

class DummyInterface(ModelStructureInterface):
>>>>>>> master:test/test_em_framework/test_model_ensemble.py
