...
_namespace = {
    ...
    'TIME': 'time', 'Time': 'time', 'Sales': 'sales',
    'Total Cumulative Income': 'total_cumulative_income',
    'Total Cumulative Sales': 'total_cumulative_sales', 'SAVEPER': 'saveper',
    'FINAL TIME': 'final_time', 'Months of Expenses per Sale': 'months_of_expenses_per_sale',
    'Impact of Motivation on Effort': 'impact_of_motivation_on_effort',
    'Motivation Adjustment Time': 'motivation_adjustment_time',
    'Accumulating Tenure': 'accumulating_tenure', 'Motivation Adjustment': 'motivation_adjustment',
    ...
    'Total Effort Available': 'total_effort_available', 'Income': 'income',
    'Motivation': 'motivation', 'Effort Required to Make a Sale': 'effort_required_to_make_a_sale',
    'Effort': 'effort', 'INITIAL TIME': 'initial_time', 'Startup Subsidy': 'startup_subsidy',
    'TIME STEP': 'time_step', 'Tenure': 'tenure', 'Still Employed': 'still_employed'}
