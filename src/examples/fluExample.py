...
specified in Python itself. The example is based on <insert ref>.
For comparison, run both this model and the FluVensim.py and compare
the differences. 


@author: jhkwakkel
adapted from Caner Hamarat
...
from expWorkbench.model import ModelStructureInterface, SimpleModelEnsemble
...
class MexicanFlu(ModelStructureInterface):
    def __init__(self, workingDirectory, name):
        ...
        self.uncertainties.append(ParameterUncertainty((0, 0.5), "x11")) #k1
        self.uncertainties.append(ParameterUncertainty((0, 0.5), "x12")) #k2
        self.uncertainties.append(ParameterUncertainty((0.0001, 0.1), "x21")) #k3
        self.uncertainties.append(ParameterUncertainty((0.0001, 0.1), "x22")) #k4
        self.uncertainties.append(ParameterUncertainty((0, 0.5), "x31")) #k5
        self.uncertainties.append(ParameterUncertainty((0, 0.5), "x32")) #k6
        self.uncertainties.append(ParameterUncertainty((0, 0.9), "x41")) #k7
        self.uncertainties.append(ParameterUncertainty((0, 0.5), "x51")) #k8
        self.uncertainties.append(ParameterUncertainty((0, 0.5), "x52")) #k9
        self.uncertainties.append(ParameterUncertainty((0, 0.8), "x61")) #k10
        self.uncertainties.append(ParameterUncertainty((0, 0.8), "x62")) #k11
        self.uncertainties.append(ParameterUncertainty((1,1), "x71")) #k12
        self.uncertainties.append(ParameterUncertainty((1,1), "x72")) #k13
        self.uncertainties.append(ParameterUncertainty((1, 10), "x81")) #k14
        self.uncertainties.append(ParameterUncertainty((1,10), "x82")) #k15
        self.uncertainties.append(ParameterUncertainty((0, 0.1), "x91")) #k16
        self.uncertainties.append(ParameterUncertainty((0, 0.1), "x92")) #k17
        self.uncertainties.append(ParameterUncertainty((0, 200), "x101")) #k18
        self.uncertainties.append(ParameterUncertainty((0, 200), "x102")) #k19
    ...
    def run_model(self, kwargs):
        ...
        self.results = RunFluModel(x11, x12, x21, x22, x31, x32, x41, x51, x52, x61, x62, x71, x72, x81, x82, x91, x92, x101, x102)
    
    def retrieve_output(self):
        """Method for retrieving output after a model run """
        return self.results
   
    def optimize(self, case):
        pass
...
#    # End of Initialization
    ...
    Max_infected = 0
    Max_time = 0
    #for time in arange(INITIAL_TIME, FINAL_TIME, TIME_STEP):
