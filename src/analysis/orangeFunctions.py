...
import orange, orngTree, orngEnsemble, orngFSS #, orngMDS  
...
def test_multi_dimensional_scaling():
    from expWorkbench import load_results
    
    results = load_results(r'1000 flu cases.cPickle')
    figure = multi_dimensional_scaling(results, classify=classify)
    plt.show()

if __name__ == '__main__':
#    test_tree()   
#    test_random_forest_importance()
#    test_feature_selection()
    test_multi_dimensional_scaling()
