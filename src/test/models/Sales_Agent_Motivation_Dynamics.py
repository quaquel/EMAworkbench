...
_namespace = {
    ...
    'Motivation Threshold': 'motivation_threshold', 'Sales': 'sales',
    'Motivation Adjustment Time': 'motivation_adjustment_time', 'Time': 'time',
    'Startup Subsidy': 'startup_subsidy', 'Motivation': 'motivation',
    'Impact of Motivation on Effort': 'impact_of_motivation_on_effort',
    'Total Cumulative Sales': 'total_cumulative_sales',
    'Motivation Adjustment': 'motivation_adjustment', 'FINAL TIME': 'final_time', 'TIME': 'time',
    'Total Cumulative Income': 'total_cumulative_income', 'SAVEPER': 'saveper',
    'INITIAL TIME': 'initial_time', 'Still Employed': 'still_employed',
    ...
    'Accumulating Tenure': 'accumulating_tenure', 'Success Rate': 'success_rate',
    'TIME STEP': 'time_step', 'Fraction of Effort for Sales': 'fraction_of_effort_for_sales',
    'Income': 'income', 'Accumulating Sales': 'accumulating_sales', 'Tenure': 'tenure'}
