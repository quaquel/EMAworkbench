...
_namespace = {
    'Accumulating Sales': 'accumulating_sales', 'Startup Subsidy': 'startup_subsidy',
    'Still Employed': 'still_employed', 'Motivation Adjustment': 'motivation_adjustment',
    ...
    'Success Rate': 'success_rate', 'Sales Effort Available': 'sales_effort_available',
    'Income': 'income', 'Tenure': 'tenure', 'Effort': 'effort',
    ...
    'INITIAL TIME': 'initial_time', 'Motivation': 'motivation',
    'Effort Required to Make a Sale': 'effort_required_to_make_a_sale',
    'Total Cumulative Sales': 'total_cumulative_sales',
    'Motivation Threshold': 'motivation_threshold', 'TIME': 'time',
    'Accumulating Tenure': 'accumulating_tenure', 'SAVEPER': 'saveper', 'Time': 'time',
    'Sales': 'sales', 'Total Effort Available': 'total_effort_available'}
