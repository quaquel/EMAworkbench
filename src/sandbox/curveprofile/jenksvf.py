...
'''
#start from external
#adapting http://danieljlewis.org/files/2010/06/Jenks.pdf
...
def getGVF( dataList, numClass ):
    ...
    if SDAM>0:
        return (SDAM - SDCM)/SDAM,breaks
    else:
        return (SDAM - SDCM)/1,breaks        
#end from external
#start data generating functions
